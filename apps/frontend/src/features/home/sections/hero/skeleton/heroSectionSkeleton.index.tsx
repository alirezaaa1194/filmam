...
function HeroSectionSkeletonComp() {
  return (
    <section className="hero-section relative h-[240px] md:h-[624px] 2xl:h-screen w-full overflow-hidden">
      ...
      <div className="absolute z-30 top-0 left-0 right-0 w-full h-full flex flex-col justify-end gap-2 lg:gap-8 items-start px-layout-x-space py-8 lg:py-6 max-w-layout-max mx-auto">
        ...
        <div className="flex items-center lg:justify-start gap-3 lg:gap-4">
          ...
          <div className="flex items-center lg:justify-start gap-2 lg:gap-3">
            <Skeleton className="size-9 lg:size-14 rounded-md" />
          </div>
        </div>
      </div>
