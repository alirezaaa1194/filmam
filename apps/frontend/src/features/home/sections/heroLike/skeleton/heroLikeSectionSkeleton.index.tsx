...
function HeroLikeSectionSkeletonComp() {
  return (
    <section className="hero-section relative h-[240px] md:h-[624px] 2xl:h-screen w-full overflow-hidden mt-8 lg:mt-12">
      ...
      <Skeleton className="absolute z-10 top-0 left-0 w-full h-full object-cover bg-gray-12 object-top rounded-none" />
      <div className="absolute z-30 top-0 left-0 w-full h-full flex flex-col justify-end gap-2 lg:gap-8 items-start px-layout-x-space py-8 lg:py-6">
      ...
      <div className="absolute z-30 flex items-center gap-2 w-fit! start-0! end-0! mx-auto! lg:start-auto! lg:end-[108px]! bottom-2! lg:bottom-[52px]!">
...
export default HeroLikeSectionSkeletonComp;
