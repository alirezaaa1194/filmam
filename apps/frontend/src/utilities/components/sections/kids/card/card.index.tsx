...
function KidCardComp({ movie }: { movie: __MovieListItemType }) {
  ...
  return (
    <div className="relative rounded-xl select-none h-[400px] xl:h-[480px]">
      <Image draggable={false} src={movieThumbnail?.path || ""} width={300} height={482} alt={movieThumbnail?.alt_text || movie.title} className="w-full h-full object-cover rounded-xl bg-gray-11" />
