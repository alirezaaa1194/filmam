...
function PuzzleSliderItemComp({ movie }: { movie: MovieListItemType }) {
  ...
  return (
    <div className="w-full h-full">
      <Image src={movieThumbnail?.path || ""} width={669} height={370} alt={movieThumbnail?.alt_text || movie.title} className="w-full h-full object-cover object-top rounded-xl max-h-[370px]" />
