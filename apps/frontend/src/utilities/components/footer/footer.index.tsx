...
function Footer() {
  ...
  return (
    <footer className="flex flex-col py-12 px-layout-x-space border-t border-t-gray-11 w-full mt-14 lg:mt-24">
      <div className="flex flex-col gap-4 max-w-layout-max lg:mx-auto">
        ...
        <div className="flex items-start gap-40">
          ...
          <div className="hidden lg:flex flex-col gap-2 shrink-0">
            <span className="text-body-xxs text-gray-8">
              {t("Footer.followUs")}
            </span>
            <div className="flex justify-between gap-2">
              <Link
                href="/"
                className="flex items-center justify-center size-8 bg-primary-shade-7 rounded-md"
              >
                <Image
                  src={AparatIcon}
                  width={24}
        ...
        <div className="flex lg:hidden flex-col mx-auto gap-2 shrink-0 max-w-max">
          <span className="text-body-xxs text-gray-8 text-center">
            {t("Footer.followUs")}
          </span>
          <div className="flex justify-between gap-2">
            <Link
