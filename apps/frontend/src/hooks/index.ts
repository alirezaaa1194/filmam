...
import __UseIsMobile from "./useIsMobile";
import { __UseMediaQuery } from "./useMediaQuery";
...
export { __UseIsMobile as useIsMobile };
export { __UseMediaQuery as useMediaQuery };
