...
import { Badge, Button, Separator, Tooltip, TooltipContent, TooltipTrigger } from '@/utilities/components'
        ...
        >
          <Tooltip>
            <TooltipTrigger asChild>
              ...
              >
                <X />
                <span className='sr-only'>{t('common.clear_selection')}</span>
              </Button>
            </TooltipTrigger>
            <TooltipContent>
              <p>{t('common.clear_selection')}</p>
            </TooltipContent>
          </Tooltip>
