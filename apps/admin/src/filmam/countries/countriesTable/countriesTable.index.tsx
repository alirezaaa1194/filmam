...
import { countriesColumns as columns } from '../countriesColumns/countriesColumns.index'
import { CountriesTableSkeleton } from '../countriesTableSkeleton/countriesTableSkeleton.index'
...
export function CountriesTable({ data, count, isPending }: DataTableProps) {
    ...
    >
      <div role='toolbar' className='flex items-center justify-between'>
        <div className='flex flex-1 flex-col-reverse items-start gap-y-2 sm:flex-row sm:items-center sm:space-x-2'>
          <Input
            placeholder={t('countries.filter_placeholder')}
            value={searchInput}
        ...
        <DataTableViewOptions
          ...
          labels={{
            ...
            created_at: t('countries.created_at'),
          }}
        />
      </div>
      {isPending ? (
