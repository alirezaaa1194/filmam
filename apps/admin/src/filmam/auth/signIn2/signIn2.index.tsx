...
import dashboardDark from '../signIn/assets/dashboard-dark.png'
import dashboardLight from '../signIn/assets/dashboard-light.png'
      ...
      <div className='lg:p-8'>
        ...
        <div className='mx-auto flex w-full max-w-sm flex-col justify-center space-y-2'>
          <div className='flex flex-col space-y-2 text-start'>
            <h2 className='text-lg font-semibold tracking-tight'>{t('auth.sign_in')}</h2>
