...
import { tagsColumns as columns } from '../tagsColumns/tagsColumns.index'
import { TagsTableSkeleton } from '../tagsTableSkeleton/tagsTableSkeleton.index'
...
export function TagsTable({ data, count, isPending }: DataTableProps) {
