...
import type { CreateTagPayloadType } from '../tags.type'

type TagAddDialogProps = {
  open: boolean
  onOpenChange: (open: boolean) => void
}

export function AddTagDialog({ open, onOpenChange }: TagAddDialogProps) {
    ...
    >
      <DialogContent className='sm:max-w-lg'>
        <DialogHeader className='text-start'>
          <DialogTitle>{t('tags.add_tag')}</DialogTitle>
          <DialogDescription>{t('tags.add_tag_desc')}</DialogDescription>
        </DialogHeader>
        <div className='w-[calc(100%+0.75rem)] overflow-y-auto py-1 pe-3'>
          <Form {...form}>
            ...
            >
              ...
              <Tabs
                defaultValue={tagsTabLanguageOrder[0]}
