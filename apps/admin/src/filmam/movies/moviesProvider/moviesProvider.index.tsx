...
type MoviesDialogType = 'add' | 'edit' | 'delete'

type MoviesContextType = {
  open: MoviesDialogType | null
  setOpen: (str: MoviesDialogType | null) => void
...
export function MoviesProvider({ children }: { children: React.ReactNode }) {
  const [open, setOpen] = useDialogState<MoviesDialogType>(null)
