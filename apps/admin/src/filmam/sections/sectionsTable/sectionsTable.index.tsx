...
import { sectionsColumns as columns } from '../sectionsColumns/sectionsColumns.index'
import { SectionsTableSkeleton } from '../sectionsTableSkeleton/sectionsTableSkeleton.index'

const route = getRouteApi('/_authenticated/sections/')

type DataTableProps = { data: Section[]; count: number; isPending: boolean }

export function SectionsTable({ data, count, isPending }: DataTableProps) {
    ...
    >
      <div role='toolbar' className='flex items-center justify-between'>
        <div className='flex flex-1 flex-col-reverse items-start gap-y-2 sm:flex-row sm:items-center sm:space-x-2'>
          <Input
            placeholder={t('sections.filter_placeholder')}
            value={searchInput}
        ...
        <DataTableViewOptions
          ...
          labels={{
            ...
            order: t('sections.order'),
            view_mode: t('sections.view_mode'),
            selection_mode: t('sections.selection_mode'),
            movies_count: t('sections.movies_count'),
            created_at: t('sections.created_at'),
          }}
        />
      </div>
      {isPending ? (
