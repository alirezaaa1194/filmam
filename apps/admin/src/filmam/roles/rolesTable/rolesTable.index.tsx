...
import { rolesColumns as columns } from '../rolesColumns/rolesColumns.index'
import { RolesTableSkeleton } from '../rolesTableSkeleton/rolesTableSkeleton.index'
...
export function RolesTable({ data, count, isPending }: DataTableProps) {
