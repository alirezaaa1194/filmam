...
import { factorsColumns as columns } from '../factorsColumns/factorsColumns.index'
import { FactorsTableSkeleton } from '../factorsTableSkeleton/factorsTableSkeleton.index'
...
export function FactorsTable({ data, count, isPending }: DataTableProps) {
    ...
    >
      <div role='toolbar' className='flex items-center justify-between'>
        <div className='flex flex-1 flex-col-reverse items-start gap-y-2 sm:flex-row sm:items-center sm:space-x-2'>
          <Input
            placeholder={t('factors.filter_placeholder')}
            value={searchInput}
        ...
        <DataTableViewOptions
          ...
          labels={{
            slug: t('factors.slug'),
            name: t('factors.name'),
            created_at: t('factors.created_at'),
          }}
        />
      </div>
      {isPending ? (
        <FactorsTableSkeleton />
      ) : (
