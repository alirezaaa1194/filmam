...
import { genresColumns as columns } from '../genresColumns/genresColumns.index'
import { GenresTableSkeleton } from '../genresTableSkeleton/genresTableSkeleton.index'
...
export function GenresTable({ data, count, isPending }: DataTableProps) {
    ...
    >
      <div role='toolbar' className='flex items-center justify-between'>
        <div className='flex flex-1 flex-col-reverse items-start gap-y-2 sm:flex-row sm:items-center sm:space-x-2'>
          <Input
            placeholder={t('genres.filter_placeholder')}
            value={searchInput}
        ...
        <DataTableViewOptions
          ...
          labels={{
            slug: t('genres.slug'),
            name: t('genres.name'),
            created_at: t('genres.created_at'),
          }}
        />
      </div>
      {isPending ? (
