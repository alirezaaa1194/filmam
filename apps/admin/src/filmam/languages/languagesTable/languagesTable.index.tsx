...
import { languagesColumns as columns } from '../languagesColumns/languagesColumns.index'
import { LanguagesTableSkeleton } from '../languagesTableSkeleton/languagesTableSkeleton.index'
...
export function LanguagesTable({ data, count, isPending }: DataTableProps) {
    ...
    >
      <div role='toolbar' className='flex items-center justify-between'>
        <div className='flex flex-1 flex-col-reverse items-start gap-y-2 sm:flex-row sm:items-center sm:space-x-2'>
          <Input
            placeholder={t('languages.filter_placeholder')}
            value={searchInput}
        ...
        <DataTableViewOptions
          table={table}
          labels={{
            code: t('languages.code'),
            label: t('languages.label'),
            created_at: t('languages.created_at'),
          }}
        />
      </div>
      {isPending ? (
